	...
	<div id="wrapper">
	  <div class="container bg-white">
	    <div class="row">
	    	<div class="col-md-12">
	    		<div class="phdr">
				<i class="fa fa-tags"></i> <b>Bài Viết Mới</b><a href="/forum/create/" class="badge pull-right" title="Gửi Bài Mới">Viết Bài Mới</a>
			</div>
					<div class="menu-home-tom">
						<table class="table table-striped">
							<thead>
								<tr>
									<th width="75%">Tiêu đề</th><th width="25%" class="text-right hidden-xs"> Thống kê</th>
								</tr>
							</thead>
							<tbody>
								<tr>
